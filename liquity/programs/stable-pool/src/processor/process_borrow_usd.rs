...
pub fn process_borrow_usd(ctx: Context<BorrowUsd>, amount: u64, token_vault_nonce: u8, user_trove_nonce: u8, global_state_nonce: u8, token_coll_nonce: u8, mint_usd_nonce: u8) -> ProgramResult {

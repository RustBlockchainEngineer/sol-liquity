...
pub fn process_sp_sol_gain_to_trove(ctx: Context<SPGainToTrove>, amount: u64, global_state_nonce: u8, sp_user_info_nonce: u8, stability_pool_nonce: u8) -> ProgramResult {
    msg!("withdrawing ...");
